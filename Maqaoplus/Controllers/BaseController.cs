...
namespace Maqaoplus.Controllers
{
    public class BaseController : Controller
    {
        public Customermodelresponce SessionCustomerData
        {
            ...
            {
                {
                    Customermodelresponce userDataSerializeModel = null;
                    if (base.User is ClaimsPrincipal)
                    {
                        ...
                        {
                            userDataSerializeModel = JsonConvert.DeserializeObject<Customermodelresponce>(claim);
                        }
                    }

                    base.ViewData["UserData"] = (userDataSerializeModel ?? new Customermodelresponce());
